...
In order to support loading of multiple wallets in fishery-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is fishery.cpp.
...
Changes to fishery.cpp
----------------------
fishery.cpp is the entry point into fishery-qt, and as such, will require some minor modifications to provide hooks for
