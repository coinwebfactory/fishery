Contributing to Fishery Core
============================

The Fishery Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Fishery Core project, and is not to be
confused with overall Fishery Network Protocol consensus changes.

Whether a pull request is merged into Fishery Core rests with the project merge
...
Patches that change Fishery consensus rules are considerably more involved than
...
Where a patch set proposes to change the Fishery consensus, it must have been
...
The project leader is the release manager for each Fishery Core release.
