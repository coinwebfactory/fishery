...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Fishery Core fishery-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  fishery-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded fishery transaction") + "\n" +
                               "  fishery-tx [options] -create [commands]   " + _("Create hex-encoded fishery transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded fishery transaction
