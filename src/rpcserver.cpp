...
Value stop(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "Fishery server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Fishery features */
        {"fishery", "masternode", &masternode, true, true, false},
        {"fishery", "listmasternodes", &listmasternodes, true, true, false},
        {"fishery", "getmasternodecount", &getmasternodecount, true, true, false},
        {"fishery", "masternodeconnect", &masternodeconnect, true, true, false},
        {"fishery", "masternodecurrent", &masternodecurrent, true, true, false},
        {"fishery", "masternodedebug", &masternodedebug, true, true, false},
        {"fishery", "startmasternode", &startmasternode, true, true, false},
        {"fishery", "createmasternodekey", &createmasternodekey, true, true, false},
        {"fishery", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"fishery", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"fishery", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"fishery", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"fishery", "getmasternodescores", &getmasternodescores, true, true, false},
        {"fishery", "mnbudget", &mnbudget, true, true, false},
        {"fishery", "preparebudget", &preparebudget, true, true, false},
        {"fishery", "submitbudget", &submitbudget, true, true, false},
        {"fishery", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"fishery", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"fishery", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"fishery", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"fishery", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"fishery", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"fishery", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"fishery", "checkbudgets", &checkbudgets, true, true, false},
        {"fishery", "mnsync", &mnsync, true, true, false},
        {"fishery", "spork", &spork, true, true, false},
        {"fishery", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"fishery", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use fisheryd, or the -server option to fishery-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> fishery-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:5720/\n";
}
