...
public:
    ...
    void setZSubControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintFISHERY_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendFISHERY_clicked();
    void on_pushButtonZSubControl_clicked();
