                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Fishery Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Fishery address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and fishery: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for FISHERY"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Fishery Core"), this);
    aboutAction->setStatusTip(tr("Show information about Fishery Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Fishery"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Fishery addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Fishery addresses"));
    ...
    openAction->setStatusTip(tr("Open a Fishery: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Fishery Core help message to get a list with possible Fishery command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Fishery Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Fishery network", "", count));
}
...
{
    QString strTitle = tr("Fishery Core"); // default title
