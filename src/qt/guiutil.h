...
/** Utility functions used by the Fishery Qt UI.
 */
namespace GUIUtil
{
...
// Render Fishery addresses in monospace font
...
// Parse "fishery:" URI into recipient object, return true on successful parsing
