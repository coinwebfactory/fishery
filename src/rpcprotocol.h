...
enum RPCErrorCode {
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED = -9,        //! Fishery is not connected
    ...
    RPC_WALLET_PASSFISHASE_INCORRECT = -14, //! The wallet passphrase entered was incorrect
