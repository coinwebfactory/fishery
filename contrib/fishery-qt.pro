...
RESOURCES += src/qt/fishery.qrc src/qt/fishery_locale.qrc

TRANSLATIONS += src/qt/locale/fishery_bg.ts \
                src/qt/locale/fishery_de.ts \
                src/qt/locale/fishery_en.ts \
                src/qt/locale/fishery_es.ts \
                src/qt/locale/fishery_fi.ts \
                src/qt/locale/fishery_fr.ts \
                src/qt/locale/fishery_it.ts \
                src/qt/locale/fishery_ja.ts \
                src/qt/locale/fishery_pl.ts \
                src/qt/locale/fishery_pt.ts \
                src/qt/locale/fishery_ru.ts \
                src/qt/locale/fishery_sk.ts \
                src/qt/locale/fishery_sv.ts \
                src/qt/locale/fishery_vi.ts \
                src/qt/locale/fishery_zh_CN.ts \
                src/qt/locale/fishery_zh_TW.ts
